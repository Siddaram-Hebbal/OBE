...
CREATE TABLE `organisation_units` (
  `organisation_unit_id` int(11) NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='parent organisation unit is used to create sub_organisation_units helps in creating organisation unit hierarchy';
