...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    StudentTransaction transaction = new StudentTransaction();	
    	List<StudentMember> studentMembers =  transaction.getStudentList();  
    	Iterator<StudentMember> it = studentMembers.iterator(); 
%>
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor">Student Board</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="../boards/dashboardAdmin.jsp">Home</a></li>
                            <li class="breadcrumb-item "><a href="../boards/staffBoard.jsp">Student Board</a></li>
                             <li class="breadcrumb-item active">View Student Members</li>
                        </ol>
                    </div>
                    <div class="col-md-7 col-4 align-self-center">
                         <a href="createStudent.jsp" class="btn waves-effect waves-light btn-success pull-right hidden-sm-down"> Add Student</a> 
                    </div>
                </div>
                <!-- ============================================================== -->
                    ...
                    <div class="col-12">
                    	...
                    	<%-- <c:if test="${message} != null"> --%>
                            ...
                            <div class="card-block">
                                <h4 class="card-title">Student Members</h4>
                                ...
                                <div class="table-responsive" style="height: 100%;overflow-x: inherit;">
									...
									try {
									while(it.hasNext()){
										StudentMember student = it.next();
										%>
										<tr>
                                                <td><%=student.getStudentAdmNo()%></td> 
                                                <td><%=student.getFirstname() %></td>
                                                <td><%=student.getCreatedAt() %></td>
                                                <td><%=student.getPhoneNo() %></td>
                                                <td>
													<!-- Right aligned menu below button -->
													<button id="<%=student.getId()%>"
													...
													<ul
														...
														for="<%=student.getId()%>">
														<li class="mdl-menu__item"><a href="createCourseInfo.jsp?courseId=<%=student.getId()%>">Add Info</a></li>
														<li class="mdl-menu__item"><a href="editStudent.jsp?id=<%=student.getId()%>">Edit Student</a></li>
