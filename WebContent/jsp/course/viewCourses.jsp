            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-7 col-4 align-self-center">
                         <a href="createCourse.jsp" class="btn waves-effect waves-light btn-success pull-right hidden-sm-down"> Create Course</a> 
                    </div>
                </div>
                <!-- ============================================================== -->
										...
										<tr>
                                                ...
                                                <td>
													...
													<ul
														...
														for="<%=course.getId()%>">
														<li class="mdl-menu__item"><a href="createCourseInfo.jsp?courseId=<%=course.getId()%>">Add Info</a></li>
