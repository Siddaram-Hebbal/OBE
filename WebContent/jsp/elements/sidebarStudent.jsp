                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li> <a class="waves-effect waves-dark" href="../boards/studentBoard.jsp" aria-expanded="false"><i class="mdi mdi-account-check"></i><span class="hide-menu">Student</span></a>
                       	...
                       	<li> <a class="waves-effect waves-dark" href="../student/studentProfile.jsp" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Student Profile</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="../student/notifications.jsp" aria-expanded="false"><i class="mdi mdi-account-check"></i><span class="hide-menu">Notification</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="../exam/directAssesment.jsp" aria-expanded="false"><i class="mdi mdi-account-check"></i><span class="hide-menu">Direct Assesments</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="../exam/indirectAssement.jsp" aria-expanded="false"><i class="mdi mdi-account-check"></i><span class="hide-menu">Indirect Assesments</span></a>
                        </li>
