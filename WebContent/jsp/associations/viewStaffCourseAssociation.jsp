...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%
    	...
    	List<StaffCourseAssociation> staffCourseAssociations =  transaction.getStaffCourseAllocationList();   
    	Iterator<StaffCourseAssociation> it = staffCourseAssociations.iterator(); 
%>
                    ...
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item "><a href="../boards/staffBoard.jsp">Staff Board</a></li>
                             <li class="breadcrumb-item active">View Staff-Course Association</li>
                        </ol>
                    </div>
                    <div class="col-md-7 col-4 align-self-center">
                         <a href="step2AddCourseAssociation.jsp" class="btn waves-effect waves-light btn-success pull-right hidden-sm-down"> Allocate Course to Staff</a> 
                    </div>
                </div>
                <!-- ============================================================== -->
                ...
                <div class="row">
                    <div class="col-12">
                    	...
                    	<%-- <c:if test="${message} != null"> --%>
							...
							%>   
							<%
								if(staffCourseAssociations!=null){
									%>
									<div class="card">
                            <div class="card-block">
                                ...
                                <div class="table-responsive" style="height: 100%;overflow-x: inherit;">
									...
									try {
									while(it.hasNext()){
										StaffCourseAssociation staffCourseAssociation = it.next();
										%>
									
										<tr>
                                                <td><%=staffCourseAssociation.getOrgUnit() %></td>
                                                <td><%=staffCourseAssociation.getStaffName()%></td>
                                               <td><%=staffCourseAssociation.getStaffCode()%></td>
                                                <td><%=staffCourseAssociation.getStaffRole()%></td>
                                                <td><%=staffCourseAssociation.getRoleCode()%></td>
                                                <td><%=staffCourseAssociation.getCourseName()%></td>
                                                <td><%=staffCourseAssociation.getCourseCode()%></td>
                                                <td><%=staffCourseAssociation.getReportingToStaff()%></td>
                                                <td><%=staffCourseAssociation.getReportingStaffCode()%></td>
                                                
                                                <td>
													<!-- Right aligned menu below button -->
													<button id="<%=staffCourseAssociation.getId()%>"
													...
													<ul
														...
														for="<%=staffCourseAssociation.getId()%>">
														<li class="mdl-menu__item"><a href="createCourseInfo.jsp?courseId=<%=staffCourseAssociation.getId()%>">Add Info</a></li>
