...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    StaffTransaction transaction = new StaffTransaction();	
    	List<StaffMember> staffMembers =  transaction.getStaffList();  
                    ...
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item "><a href="../boards/staffBoard.jsp">Staff Board</a></li>
                             <li class="breadcrumb-item active">View Staff Members</li>
                        </ol>
                    </div>
                    <div class="col-md-7 col-4 align-self-center">
                         <a href="createStaff.jsp" class="btn waves-effect waves-light btn-success pull-right hidden-sm-down"> Create Staff</a> 
                    </div>
                </div>
                <!-- ============================================================== -->
										...
										<tr>
                                                ...
                                                <td>
													...
													<ul
														...
														for="<%=staff.getId()%>">
														<li class="mdl-menu__item"><a href="createCourseInfo.jsp?courseId=<%=staff.getId()%>">Add Info</a></li>
														<li class="mdl-menu__item"><a href="editStaff.jsp?id=<%=staff.getId()%>">Edit Staff</a></li>
