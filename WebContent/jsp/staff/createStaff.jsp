                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-block">
                                <form class="form-horizontal form-material" action="processCreateStaff.jsp" method="post">
                                	<div class="form-group">
                                        <label class="col-md-12">Staff Code</label>
                                        <div class="col-md-12">
                                            <input placeholder="Staff code" class="form-control form-control-line" type="text" id="staffCode" name="staffCode">
                                        </div>
                                    </div>
                                    <div class="form-group">
