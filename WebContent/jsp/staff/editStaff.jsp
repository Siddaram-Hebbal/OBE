...
StaffMember staffMember =  transaction.getStaffDetailsById(id);
System.out.println("StaffList : " +staffMember);
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor">Create Staff</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="../boards/staffBoard.jsp">Staff Dashboard</a></li>
                            <li class="breadcrumb-item active">Create Staff Profile</li>
                        </ol>
                    </div>
                    <div class="col-md-7 col-4 align-self-center">
                         <a href="../boards/staffBoard.jsp" class="btn waves-effect waves-light btn-success pull-right hidden-sm-down"> View Staff</a> 
                    </div>
                </div>
                <!-- ============================================================== -->
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-block">
                                <form class="form-horizontal form-material" action="processUpdateStaff.jsp?id=<%=staffMember.getId() %>" method="post">
                                	<div class="form-group">
                                        <label class="col-md-12">Staff Code</label>
                                        <div class="col-md-12"> 
                                            <input placeholder="Staff code" class="form-control form-control-line" type="text" id="staffCode" name="staffCode" value="<%=staffMember.getStaffCode()%>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input placeholder="first name" class="form-control form-control-line" type="text" id="firstName" name="firstName" value="<%=staffMember.getFirstname() %> ">
                                        </div>
                                    </div>
                                     <div class="form-group">
                                        <label class="col-md-12">Middle Name</label>
                                        <div class="col-md-12">
                                            <input placeholder="Middle name" class="form-control form-control-line" type="text" id="middleName" name="middleName" value="<%=staffMember.getMiddlename() %>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Last Name</label>
                                        <div class="col-md-12">
                                            <input placeholder="last name" class="form-control form-control-line" type="text" id="lastName" name="lastName" value="<%=staffMember.getLastname()%>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                        ...
                        <!-- <div class="form-group md-form">
							...
							Grid row
									 ...
									 <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input placeholder="dob" class="form-control form-control-line" type="text" id="dob" name="dob"value="<%=staffMember.getDob()%>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input placeholder="johnathan@admin.com" class="form-control form-control-line" name="email" id="email" type="email" value="<%=staffMember.getEmail()%>">
                                        </div>
                                    </div>
	...
	private String otherDetails;
                    	 -->
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input placeholder="123 456 7890" class="form-control form-control-line" type="text" id="phoneNo" name="phoneNo" value="<%=staffMember.getPhoneNo()%>">
                                        </div>
                                    </div>
                                     <div class="form-group">
                                        <label class="col-md-12">Message</label>
                                        <div class="col-md-12">
                                            <textarea rows="5" class="form-control form-control-line" name="message" > <%=staffMember.getMessage()%></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Address</label>
                                        <div class="col-md-12">
                                            <textarea rows="5" class="form-control form-control-line" name="address"><%=staffMember.getAddress()%></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Other Details</label>
                                        <div class="col-md-12">
                                            <textarea rows="5" class="form-control form-control-line" name="otherDetails" ><%=staffMember.getOtherDetails()%></textarea>
                                        </div>
                                    </div> 
                ...
                <%System.out.println("Message-----------"+staffMember.getMessage());%>
            <%
