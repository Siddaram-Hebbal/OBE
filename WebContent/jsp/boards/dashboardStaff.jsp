...
<%
	...
	University univ = transaction.getUniversity(); 
%>    
...
<body class="fix-header fix-sidebar card-no-border">
    ...
    <div id="main-wrapper">
        ...
        <!-- ============================================================== -->
        <jsp:include page="../elements/staffHeader.jsp"></jsp:include>
        <!-- ============================================================== -->
        <!-- End Topbar header -->
        <!-- ============================================================== -->
        <!-- ============================================================== -->
        ...
        <!-- ============================================================== -->
       <jsp:include page="../elements/sidebarStaff.jsp"></jsp:include>
        <!-- ============================================================== -->
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-7 col-4 align-self-center">
                        <a href="../universityOnBoard.jsp" class="btn waves-effect waves-light btn-success pull-right hidden-sm-down"> Create University</a>
                    </div>
                    <%
                    	}
                    %>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-block">
                               <div class="row">
                                            <div class="col-md-3 col-xs-6 b-r"> <strong>University Name</strong>
                                                <br>
                                                <p class="text-muted"><%=univ.getName() %></p>
                                            </div>
                                            <div class="col-md-3 col-xs-6 b-r"> <strong>Code</strong>
                                                <br>
                                                <p class="text-muted"><%=univ.getRegistrationCode()%></p>
                                            </div>
                                            <div class="col-md-3 col-xs-6 b-r"> <strong>Website</strong>
                                                <br>
                                                <p class="text-muted"><%=univ.getWebsite() %></p>
                                            </div>
                                            <div class="col-md-3 col-xs-6"> <strong>Email</strong>
                                                <br>
                                                <p class="text-muted"><%=univ.getEmail()  %></p>
                                            </div>
                                        </div>
                            </div>
                        </div>
