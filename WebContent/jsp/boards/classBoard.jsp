            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor">Class Board</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="dashboardAdmin.jsp">Home</a></li>
                            <li class="breadcrumb-item active">ClassBoard</li>
                        </ol>
                    </div>
                    <div class="col-md-7 col-4 align-self-center">
                         <a href="../organisations/createOrganisation.jsp" class="btn waves-effect waves-light btn-success pull-right hidden-sm-down"> Create Class</a> 
                    </div>
                </div>
                <!-- ============================================================== -->
							...
							<div class="card-block bg-info">
								<!-- <div class="content-grid mdl-grid">
								  <div class="mdl-cell mdl-cell--9-col"> -->
								    <h4 class="text-white card-title">Class: 7</h4>
									<h6 class="card-subtitle text-white m-b-0 op-5">Class strength</h6>
								<!--   </div>
								</div>	 -->
									...
									<div class="message-widget contact-widget">
										...
										<a href="../student/viewStudent.jsp">
											...
											<div class="">
												...
												<span id="viewPO" data-toggle="modal" data-target="#exampleModal">View Students</span>
